...
window.IMPACT60 = {
  ...
  "ecoute": [
    {
      ...
      "trous": [
        {
          "avant": "Conséquence directe, la distance entre le lieu de résidence et le lieu de travail ne cesse de",
          "apres": ".",
          "reponses": [
            "s'allonger",
            "s allonger",
        ...
        {
          "avant": "Et c'est précisément là que",
          "apres": "l'erreur d'appréciation de Keynes.",
          "reponses": [
            "reside"
          ],
          "solution": "réside"
    ...
    },
    {
      ...
      "trous": [
        ...
        {
          "avant": "Nous ne résoudrons pas le problème en modifiant notre",
          "apres": "du temps.",
          "reponses": [
            "gestion"
          ],
  ...
  "formules": [
    {
      ...
      "film": {
        "texte": "Prenons un exemple concret pour bien comprendre.",
        "t": 367,
        "debut": 367.54,
        "fin": 369.85,
        "contour": [
    ...
    },
    {
      ...
      "film": {
        "texte": "Nous devrions donc pouvoir vivre de manière sereine et avoir plus de temps.",
        "t": 334,
        "debut": 335.48,
        "fin": 339.31,
        "contour": [
    ...
    },
    {
      ...
      "film": {
        "texte": "Résultat, le trajet quotidien pour se rendre au travail prend aujourd'hui plus de temps qu'auparavant.",
        "t": 417,
        "debut": 418.4,
        "fin": 423.37,
        "contour": [
    ...
    },
    {
      ...
      "film": {
        "texte": "Ce qu'il n'avait pas vu venir, c'est l'avènement du consumérisme.",
        "t": 442,
        "debut": 443.38,
        "fin": 446.97,
        "contour": [
    ...
    },
    {
      ...
      "film": {
        "texte": "Plus elles nous facilitent la vie, plus elles nous permettent de compliquer celle des autres.",
        "t": 957,
        "debut": 957.36,
        "fin": 962.21,
        "contour": [
    ...
    },
    {
      ...
      "film": {
        "texte": "Si l'accélération est le problème, alors la réponse devrait être le ralentissement. Mais je pense que c'est une erreur.",
        "t": 1347,
        "debut": 1346.8,
        "fin": 1353.19,
        "contour": [
  ...
  "prononciation": {
    ...
    "protocole": [
      "Écoutez la phrase du film deux fois, sans lire.",
      "Réécoutez-la en suivant la courbe de mélodie et les ↗ ↘ du modèle.",
      "Passez en vitesse 0,75 et en boucle : murmurez en même temps que la voix, seulement la mélodie.",
      "Revenez en vitesse normale et parlez en même temps que la voix, à voix haute (shadowing), deux fois.",
      "Enregistrez-vous seul·e et comparez votre courbe à celle du modèle."
    ],
    "autocontrole": [
  ...
  "semaine": [
    {
      "jour": "J+1",
      "tache": "Shadowing de l'extrait « Plus…, plus… » (15:57), 10 minutes, en suivant le protocole en 5 étapes."
    },
    {
      "jour": "J+2",
      "tache": "Rappel des 8 formules en mode « rappel », sans regarder : une phrase sur votre métier pour chacune, à voix haute."
    },
    {
      "jour": "J+3",
      "tache": "Shadowing de Rosa (22:27), puis enregistrez-vous une fois et comparez les fins de groupe."
    },
    {
      "jour": "J+4",
      "tache": "Placez votre formule de la semaine dans une vraie réunion. Notez la phrase exacte."
    },
    {
      "jour": "J+5",
      "tache": "Enregistrez 60 secondes sur la situation du jour, sans notes, et envoyez-les à votre formateur."
    }
  ],
  "seance2": {
  ...
  "formateur": {
    "deroule": [
      {
        "temps": "0–5",
        "phase": "Mesure à froid",
        "role": "Lancez l'enregistrement de 90 s sans préparation. Ne corrigez rien. Notez deux ou trois erreurs récurrentes."
      },
      {
        "temps": "5–15",
        "phase": "Écoute ciblée",
        "role": "Faites prédire avant chaque écoute. Après la deuxième écoute, faites repérer où et pourquoi l'apprenant a décroché (débit, mots soudés, chiffres)."
      },
      {
        "temps": "15–25",
        "phase": "Formules",
        "role": "Répétition en chœur, puis mode rappel (fonction → formule). Faites produire l'exemple dans le métier de l'apprenant, pas celui de la page."
      },
      {
        "temps": "25–33",
        "phase": "Prononciation",
        "role": "Une seule cible. Faites d'abord percevoir (quiz), puis produire (shadowing). Corrigez par incitation : « Où est l'accent ? », « Encore, en allongeant la fin »."
      },
      {
        "temps": "33–50",
        "phase": "Tâche en 3 tours",
        "role": "Jouez l'interlocuteur. Au tour 2, lisez une objection. Entre les tours, apportez les formules indiquées, rien d'autre."
      },
      {
        "temps": "50–56",
        "phase": "Mesure finale",
        "role": "Même consigne qu'au début, 90 s. Comparez les chiffres à voix haute avec l'apprenant."
      },
      {
        "temps": "56–60",
        "phase": "Engagement",
        "role": "Une formule, une réunion réelle, une date. Rappelez le plan de 10 minutes par jour."
      }
    ],
    "feedback": [
    ...
    "voix": [
      "Les phrases du film se jouent dans le lecteur YouTube officiel, calées au centième de seconde, en boucle et à vitesse 0,75 si besoin. Aucun extrait n'est copié.",
      "Les exemples métier cherchent d'abord votre voix dans audio/formateur/, puis une voix neuronale dans audio/neuronal/. Sans fichier, aucun bouton ne s'affiche.",
      "Noms de fichiers attendus : <formule>-<profil>.mp3, par exemple f1-juriste.mp3, i2-clinique.mp3. La liste complète est dans le mode d'emploi.",
      "Pourquoi plusieurs voix ? Entendre plusieurs locuteurs (film, formateur, voix neuronales) aide à généraliser la perception (entraînement phonétique à haute variabilité)."
    ]
  },
  "voix": {
    "neuronale": {
      "juriste": "fr-FR-RemyMultilingualNeural",
      "clinique": "fr-FR-VivienneMultilingualNeural",
      "direction": "fr-FR-RemyMultilingualNeural"
    },
    "dossiers": {
      "formateur": "audio/formateur/",
      "neuronale": "audio/neuronal/"
    },
    "credits": "Phrases du film : documentaire ARTE, lu dans le lecteur YouTube officiel. Voix neuronales éventuelles : Microsoft Azure (Rémy, Vivienne)."
  }
};
